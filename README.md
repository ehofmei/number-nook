...
- [The Garden Winglets collection](./docs/GARDEN_WINGLETS.md) — the first bird roster, real-species visual anchors, dual-art production record, and species-specific guardrails.
- [The Pondside Pals collection](./docs/PONDSIDE_PALS.md) — the completed mixed-species pond collection, including roster, rarities, personalities, themes, Classic art, and Sticker production record.
